...
async function installAlarmMonitoring(session) {
    ...
    const fields = await (0, client_alarm_tools_extractConditionFields_1.extractConditionFields)(session, "AlarmConditionType");
    ...
    try {
        await (0, client_tools_1.callConditionRefresh)(subscription);
    }
    catch (err) {
